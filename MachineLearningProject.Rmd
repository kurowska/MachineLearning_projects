...
as well as random forests, with very slight differences. Boosted regression is 
a bit faster (on the machine this report is done with parameters described above)
than random forests which is reason good enough to choose it as the final model. 
